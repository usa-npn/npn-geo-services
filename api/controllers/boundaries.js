...
function boundary(req, res) {
    ...
    let boundaryPath = `${process.env.PROTOCOL}://${process.env.GEOSERVER_HOST}/geoserver/gdd/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=${layer}&CQL_FILTER=${boundaryColumn}='${boundary}'&outputFormat=${outputFormat}`;
